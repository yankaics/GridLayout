...
/**
 * {see
 * https://github.com/Frank-Zhu/AndroidRecyclerViewDemo/blob/master/app%2Fsrc%
 * 2Fmain%2Fjava%2Fcom%2Ffrankzhu%2Frecyclerviewdemo%2Fview%
 * 2FFullyLinearLayoutManager.java}
 * Created by ZhuWenWu
 */
public class FullyLinearLayoutManager extends LinearLayoutManager {
    ...
    public void onMeasure(RecyclerView.Recycler recycler,
        ...
        for (int i = 0; i < getItemCount(); i++) {
            measureScrapChild(recycler,
                              i,
                              View.MeasureSpec.makeMeasureSpec(widthSize,
                                                               widthMode),
                              View.MeasureSpec.makeMeasureSpec(heightSize,
                                                               heightMode),
                              mMeasuredDimension);
    ...
    private void measureScrapChild(RecyclerView.Recycler recycler,
        ...
        try {
            View view = recycler.getViewForPosition(position);// fix
